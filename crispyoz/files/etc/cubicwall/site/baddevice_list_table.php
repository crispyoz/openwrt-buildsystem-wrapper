...
if($_SESSION['list_name']=='bd')
    $_SESSION['table_name']='blocked_device';
...
try{
    ...
    $result = $db->query('select id, frag from ' . $_SESSION['table_name'] . ' where disabled=false');
?>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800"  align="center"><?php echo(ucwords(str_replace("_", " ", $_SESSION['table_name'])))  ;?> List </h1>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 cutomeHeader">
                            ...
                            <button type="button" class="btn btn-primary addbutton" data-toggle="modal" data-target="#exampleModal">
                                <?php
                                    if($_SESSION['list_name']=='bd') echo('Add Device to Block');
                                ?>
...
<?php include("inc/add_bad_device_list_dialog.php"); ?>
